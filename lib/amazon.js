...
const MAX_LAMBDA_ZIP_SIZE = 50000000
...
function verifyZipFile (zipFile) {
  ...
  if (zipFile.byteLength >= MAX_LAMBDA_ZIP_SIZE) throw new Error(`Lambda size exceeded, ${prettyBytes(zip.byteLength)}, current max size is 50 MB`)
}
