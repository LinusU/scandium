const { APIGatewayClient, CreateDeploymentCommand, GetRestApisCommand, ImportRestApiCommand, PutRestApiCommand } = require('@aws-sdk/api-gateway')
const { AttachRolePolicyCommand, CreateRoleCommand, IAMClient } = require('@aws-sdk/iam')
const { AddPermissionCommand, CreateFunctionCommand, GetFunctionConfigurationCommand, InvokeCommand, LambdaClient, UpdateFunctionCodeCommand, UpdateFunctionConfigurationCommand } = require('@aws-sdk/lambda')
const { PutObjectCommand, S3Client } = require('@aws-sdk/s3')
