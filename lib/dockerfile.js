...
exports.generate = function (options) {
  ...
  lines.push('FROM amazonlinux:2.0.20200722.0')

  // Install prerequisites
  lines.push('RUN yum install -y gcc gcc-c++ git make openssl-devel tar zip')
  lines.push('RUN curl https://nodejs.org/download/release/v12.18.4/node-v12.18.4-linux-x64.tar.gz | tar xz -C /usr --strip-components=1')

  // Install package managers
  lines.push('RUN npm install -g npm@6.14.6')
