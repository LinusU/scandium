...
exports.generate = function (options) {
  ...
  lines.push('RUN curl https://nodejs.org/download/release/v12.15.0/node-v12.15.0-linux-x64.tar.gz | tar xz -C /usr --strip-components=1')

  // Install package managers
  lines.push('RUN npm install -g npm@6.13.4')
  if (yarn) lines.push('RUN npm install -g yarn@1.22.4')
